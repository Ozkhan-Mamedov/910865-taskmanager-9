...
(function () {
  ...
  cardsContainer.classList.add(`board`, `container`);
  const cardsContainerInner = document.createElement(`div`);
  cardsContainerInner.classList.add(`board__tasks`);
   ...
   * @return {string}
   */
  const getSearchComponent = function () {
    return `
   ...
   * @return {string}
   */
  const getFilterComponent = function () {
    return `
   ...
   * @return {string}
   */
  const getCardEditComponent = function () {
    return `
   ...
   * @return {string}
   */
  const getButtonComponent = function () {
   ...
   * @param {string} markup
   */
  const renderComponent = function (container, markup) {
  ...
  renderComponent(cardsContainerInner, getCardEditComponent());
  for (let i = 0; i < CARD_NUMBER; i++) {
    renderComponent(cardsContainerInner, getCardComponent());
  }
  renderComponent(cardsContainer, getButtonComponent());
})();
